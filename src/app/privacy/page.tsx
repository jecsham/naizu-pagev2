  ...
  return (
    <div className="container prose prose-invert mx-auto">
      <div className="text-center">
        <h3>Privacy Policy for NAIZU</h3>
      </div>

      <p>
        At naizu.net, accessible from https://naizu.net, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by naizu.net and how we use
        it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in naizu.net. This policy is not applicable to any
        information collected offline or via channels other than this website. Our Privacy Policy was created with the
        help of the <a href="https://www.privacypolicygenerator.org/">FPPG</a>.
      </p>
      ...
      <p>
        naizu.net follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of naizu.net.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on naizu.net, which are sent directly to users'
      ...
      <p>
        Note that naizu.net has no access to or control over these cookies that are used by third-party advertisers.
      </p>

      <h4>Third Party Privacy Policies</h4>

      <p>
        naizu.net's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>
        naizu.net does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
